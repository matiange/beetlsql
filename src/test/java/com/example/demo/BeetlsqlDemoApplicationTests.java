...
@SpringBootTest
class BeetlsqlDemoApplicationTests {

	public static void main(String[] args) {

		String driver = "com.mysql.jdbc.Driver";
		String url = "jdbc:mysql://localhost:3306/beetlsql?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC";
...
//Query查询
		...
		List<User> users = userQuery.andEq("name", "xiandafu").select();
